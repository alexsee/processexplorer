...
public class QueryService {
     ...
     * @return
     */
    public Log getLogStatistics(String logName, List<de.processmining.data.query.condition.Condition> conditions) {
        var db = new DatabaseModel(logName);
     ...
     * @return
     */
    public List<Variant> getAllPaths(String logName, List<de.processmining.data.query.condition.Condition> conditions) {
