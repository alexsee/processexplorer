...
/**
 * Implementation of a sequence database, where each sequence is implemented as a list of integers and should have a
 * unique id.
 *
...
public class SequenceDatabase extends ArrayList<int[]> {
    ...
    /**
     * the total number of item occurrences in this database (variable to be used for statistics)
     */
