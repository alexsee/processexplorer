...
/**
 * This is an implementation of the FPGROWTH algorithm (Han et al., 2004). FPGrowth is described here: <br/><br/>
 * <p>
 * Han, J., Pei, J., & Yin, Y. (2000, May). Mining frequent patterns without candidate generation. In ACM SIGMOD Record
 * (Vol. 29, No. 2, pp. 1-12). ACM <br/><br/>
 * <p>
