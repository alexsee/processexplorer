...
/**
 * This is an implementation of the FPClose algorithm (Grahne et al., 2004). FPGrowth is described here: <br/><br/>
 * <p>
 * Grahne, G., & Zhu, J. (2005). Fast algorithms for frequent itemset mining using fp-trees. Knowledge and Data
 * Engineering, IEEE Transactions on, 17(10), 1347-1362. * <br/><br/>
 * <p>
 * This is a version that saves the result to a file or keep it into memory if no output path is provided by the user to
 * the runAlgorithm method().
 * <p>
 * I have tried to follow the paper as much as possible. However, I did not use the FPArray optimization
 *
