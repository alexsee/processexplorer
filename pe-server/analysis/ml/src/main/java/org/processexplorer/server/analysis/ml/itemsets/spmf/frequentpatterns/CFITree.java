...
public class CFITree {
    ...
    /**
     * Perform the subset test to see if an itemset is a subset of an already found CFI with the same support
     *
    ...
    /**
     * Check if the itemset headwithP is contained in the path ending at "node" in the CFI-tree and have the same
     * support
     *
    ...
    /**
     * This method calculate the support of any frequent itemset by using the CFI-tree containing all the frequent
     * closed itemsets. Note that this method assumes that all frequent closed itemsets are stored in the CFI-tree.
     * <p>
     * **** It is not used by FPClose***.
     * <p>
     * It is instead designed for algorithms that use the CFI-tree generated by FPClose such as the algorithm for
     * generating closed association rules.
     *
