...
package org.processexplorer.server.analysis.ml.itemsets.spmf.frequentpatterns;
...
/**
 * This is an implementation of the FPMax algorithm (Grahne et al., 2004). FPGrowth is described here: <br/><br/>
 * <p>
 * High Performance Mining of Maximal Frequent Itemsets (with J. Zhu). 6th International Workshop on High Performance
 * Data Mining (HPDM '03)  * <br/><br/>
 * <p>
 * This is an optimized version that saves the result to a file or keep it into memory if no output path is provided by
 * the user to the runAlgorithm method().
 *
...
public class AlgoFPMax {
     ...
     * @param output  the output file path for saving the result (if null, the result will be returned by the method
    ...
    /**
     * Write a frequent itemset that is found to the output file or keep into memory if the user prefer that the result
    ...
    /**
     * Sort an array of items according to the total order of support This has an average performance of O(n^2)
     *
